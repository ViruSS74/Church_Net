    ...
    public partial class IDDocsDirForm : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                if (dgvData.Columns["Series"] != null) dgvData.Columns["Series"].HeaderText = "Серия";
                if (dgvData.Columns["Number"] != null) dgvData.Columns["Number"].HeaderText = "Номер";
                if (dgvData.Columns["IssuedBy"] != null) dgvData.Columns["IssuedBy"].HeaderText = "Выдано";
                if (dgvData.Columns["IssueDate"] != null) dgvData.Columns["IssueDate"].HeaderText = "Дата выдачи";
