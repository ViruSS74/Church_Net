...
using IncomeCategoryItem = ChurchBudget.IncomeCategoryService.IncomeCategoryItem;

namespace ChurchBudget.Forms
{
    public partial class IncomeCatDirForm : Form
    {
        private IncomeCategoryService _service;

        public IncomeCatDirForm()
        {
            InitializeComponent();
            _service = new IncomeCategoryService();

            // Подписка на событие загрузки (как в вашем примере)
            this.Load += new EventHandler(IncomeCatDirForm_Load);
        }

        private void IncomeCatDirForm_Load(object sender, EventArgs e)
        {
        ...
        private void AddChildNodes(TreeNode parentNode, int parentId, List<IncomeCategoryItem> allCats)
        {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            var f = new IncomeCatEditForm(parentName);
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            var f = new IncomeCatEditForm(id, name, parentName);
