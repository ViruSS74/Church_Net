...
public class ExpensesDocService
{
    private string _connectionString;

    public ExpensesDocService(string dbPath)
    {
    ...
    {
        string sql = "INSERT INTO expense_docs (doc_number, date, total) VALUES (@num, @date, @total); SELECT last_insert_rowid();";
    ...
    {
        string sql = "INSERT INTO expense_items (doc_id, category, amount, description) VALUES (@docId, @cat, @amount, @desc);";
        using (SQLiteCommand cmd = new SQLiteCommand(sql, conn, trans))
        {
